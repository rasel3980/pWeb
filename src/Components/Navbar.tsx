...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`w-full transition-all duration-300 ${scrolled ? "py-2" : "py-4"}`}
    >
            ...
            <li key={id}>
              <a
                ...
                style={{
                  ...
                  backgroundColor:
                    active === id ? "rgba(56,189,248,0.08)" : "transparent",
                }}
                onMouseEnter={(e) => {
                  if (active !== id)
      ...
      >
        <ul
          className="mx-6 p-3 rounded-xl flex flex-col gap-1 list-none"
          style={{

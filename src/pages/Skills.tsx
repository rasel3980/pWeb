...
const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-16">
      ...
      >
        <p className="text-xs font-bold tracking-widest uppercase text-emerald-400 mb-2">What I know</p>
        <h2 className="text-3xl md:text-4xl font-extrabold text-white">My Skills</h2>
          ...
          <button
            ...
            className={`px-5 py-2 rounded-full text-sm font-semibold transition-all duration-200
              ${selected.label === cat.label
                ? "bg-gradient-to-r from-emerald-400 to-violet-400 text-gray-900 shadow-lg shadow-emerald-500/20"
